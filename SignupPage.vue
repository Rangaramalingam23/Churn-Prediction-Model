  ...
  <div class="auth-wrapper">
    ...
    <div class="auth-content">
      ...
      <div class="image-container">
        <img src="@/assets/gepnic.jpg" alt="GEPNIC" class="info-image" />
        <img src="@/assets/digitalindia.jpg" alt="Digital India" class="info-image" />
      </div>
      ...
      <div class="auth-box">
        ...
        <div class="auth-footer">
          <p> New user? <router-link to="/signup" class="signup-link">Create an account</router-link>
          </p>
        </div>
      </div>
    </div>
